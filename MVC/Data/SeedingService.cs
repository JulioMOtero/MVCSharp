...
namespace MVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bbrown@email.com", new DateTime(1998,4,27),1000.0,d1);
            Seller s2 = new Seller(2, "Maria Green", "mgreen@email.com", new DateTime(1989, 3, 06), 1500.0, d2);
            Seller s3 = new Seller(3, "Alex Grey", "agrey@email.com", new DateTime(1979, 8, 05), 1200.0, d3);
            Seller s4 = new Seller(4, "Martha Red", "mred@email.com", new DateTime(1945, 12, 31), 1300.0, d4);
            Seller s5 = new Seller(5, "Donald Blue", "dblue@email.com", new DateTime(1999, 9, 09), 1600.0, d3);
            Seller s6 = new Seller(6, "Alex Pink", "apink@email.com", new DateTime(1977, 10, 23), 1900.0, d2);
